...
class MosaicPropertyModificationBuffer {
    getModificationtype = () => {
    ...
    static loadFromBinary(consumableBuffer) {
        var object = new MosaicPropertyModificationBuffer()
...
class MosaicPropertyTransactionBodyBuffer {
    getPropertytype = () => {
    ...
    static loadFromBinary(consumableBuffer) {
        var object = new MosaicPropertyTransactionBodyBuffer()
        ...
        for (i = 0; i < modificationsCount; i++) {
            var newmodifications = MosaicPropertyModificationBuffer.loadFromBinary(consumableBuffer)
...
class MosaicPropertyTransactionBuffer {
    getSize = () => {
        return this.size
    }
    ...
    calculateSize = () => {
        var size = 122 + ( this.modifications.length * 9 )
        this.size = uint_to_buffer(size, 4)
    }

    static loadFromBinary(consumableBuffer) {
        var object = new MosaicPropertyTransactionBuffer()
...
class EmbeddedMosaicPropertyTransactionBuffer {
    getSize = () => {
        return this.size
    }
    ...
    calculateSize = () => {
        var size = 42 + ( this.modifications.length * 9 )
        this.size = uint_to_buffer(size, 4)
    }

    static loadFromBinary(consumableBuffer) {
        var object = new EmbeddedMosaicPropertyTransactionBuffer()
        var size = consumableBuffer.get_bytes(4)
        object.size = size
        var signer = consumableBuffer.get_bytes(32)
        object.signer = signer
